...
BEGIN
    ...
    IF (
        sentence[i] = "a"|| sentence[i] = "A" || sentence[i] ="e"|| sentence[i]="E" OR sentence[i]="y" OR sentence[i]="Y" OR sentence[i]="u" OR sentence[i]="U" OR sentence[i]="i" OR sentence[i]="I" OR sentence[i]="o" OR sentence[i]="O" 
)
THEN
